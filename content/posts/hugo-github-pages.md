...
3. [安装hugo(extended edition, v0.112.0 or later)](https://gohugo.io/installation/)
   ...
   - 打开 Github 中的 [Hugo](https://github.com/gohugoio/hugo) 库，打开右边侧边栏About下面的 Realeases，下载最新的版本，本次下载为：[hugo_extended_0.121.1_windows-amd64.zip](https://github.com/gohugoio/hugo/releases/download/v0.121.1/hugo_extended_0.121.1_windows-amd64.zip)
     ...
     ![image-20231227181602909](../../static/imgs/image-20231227181602909.png)
   ...
   - 打开命令行，输入 `hugo version`，显示版本号即为安装成功
     ...
     ![image-20231227181823311](../../static/imgs/image-20231227181823311.png)
...
Hugo 在目录中创建了文件夹`content/posts`，此路径下创建了文件啊`my-first-post.md`，使用编辑器打开文件。（此处使用markdown编辑器Typora），可以看到默认内容为：
...
![image-20231228143322332-17037687158431](../../static/imgs/image-20231228143322332-17037687158431.png)
...
![image-20231228215625260](../../static/imgs/image-20231228215625260.png)
...
![image-20231228215747849](../../static/imgs/image-20231228215747849.png)
